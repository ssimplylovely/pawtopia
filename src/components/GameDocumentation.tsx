          ...
          >
            ...
            <Card className="p-6 bg-gradient-to-br from-purple-900/40 to-blue-900/40 border-purple-500/30 hover:border-purple-400/50 transition-all shadow-lg">
              <p className="text-white/90 mb-4 leading-relaxed">
                <strong className="text-purple-300">Pawtopia</strong> adalah virtual pet game berbasis NFT di blockchain OneChain yang menggabungkan aspek pet simulation, koleksi NFT, dan play-to-earn economy. Pemain dapat mengadopsi hewan peliharaan virtual unik sebagai NFT, merawat mereka melalui berbagai interaksi, menaikkan level, berkompetisi dalam battle arena, dan mendapatkan token ONEP sebagai reward.
              </p>
              <div className="space-y-2">
                <h4 className="text-white font-semibold mb-3">Cara Bermain:</h4>
                <div className="grid gap-2">
                  {[
                    { emoji: '🏠', text: 'Adopsi Pet NFT - Pilih dan mint pet unik' },
                    { emoji: '💝', text: 'Rawat & Interaksi - Beri makan, bermain, istirahat' },
                    { emoji: '⬆️', text: 'Level Up - Dapatkan XP dan tingkatkan level' },
                    { emoji: '⚔️', text: 'Battle & Quest - Lawan musuh di arena' },
                    { emoji: '💰', text: 'Earn Rewards - Dapatkan token ONEP' },
                    { emoji: '🛒', text: 'Trade & Collect - Jual, beli, koleksi pet langka' }
                  ].map((step, i) => (
                ...
                <Card className="p-6 bg-gradient-to-br from-white/5 to-purple-900/20 backdrop-blur-sm border-white/10 hover:border-purple-400/30 transition-all">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <div className="space-y-2">
                        {[
                          { icon: '🍖', name: 'Hunger', desc: 'Menurun seiring waktu' },
                          { icon: '😊', name: 'Happiness', desc: 'Tingkatkan dengan bermain' },
                          { icon: '❤️', name: 'Health', desc: 'Dipengaruhi interaksi' },
                          { icon: '⚡', name: 'Energy', desc: 'Untuk aktivitas' }
                        ].map((stat, i) => (
                    ...
                    <div>
                      <p className="text-white/70 mb-2 font-semibold">Interaksi & Rewards:</p>
                      <div className="space-y-2">
                        {[
                  ...
                  <div className="mt-4 p-4 bg-gradient-to-r from-purple-600/30 to-pink-600/30 rounded-lg border border-purple-500/30">
                    <p className="text-white/90"><strong>⭐ Leveling:</strong> Membutuhkan Level × 100 XP. Bonus +50 ONEP saat level up! Max Level: 100</p>
                  </div>
                </Card>
              </motion.div>
